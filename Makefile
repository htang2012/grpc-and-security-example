...
all: system-check greeter_secure_client greeter_secure_server 
...
clean:
	rm -f *.o *.pb.cc *.pb.h greeter_secure_client greeter_secure_server greeter_async_client greeter_async_client2 greeter_async_server
